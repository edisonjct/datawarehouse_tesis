                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form id="cubo" class="form-horizontal form-label-left">                                          
                                            <input type="text" class="hidden" name="proceso" value="clientes" />
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                                    ...
                                                    <button type="button" id="btn-clientes" class="btn btn-success">Procesar</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>                                    
