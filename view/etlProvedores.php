                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="alert alert-info alert-dismissible fade in">
                            ...
                            <strong>Info!</strong> Procesos ETL para generación del Cubo de Provedores
                        </div>
                        <div class="clearfix"></div>                        
                        <div class="row" id="">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>ETL PROVEDORES</h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <button id="btn-provedores" class="btn btn-danger" onclick="etlprovedores();">Procesar</button>
                                        </ul>
                                        <div class="clearfix"></div>                                        
                                    </div>
                                    <div class="x_content">
                                        <div id="etlprovedores" style="min-width: 310px; height: auto; margin: 0 auto"></div>
                                    </div>
                                </div>
                            </div>                                                                                    
                        </div>                       
