        ...
        18: [function(_dereq_, module, exports) {
                ...
                render: function() {
                    ...
                    if (config.canMoveFields) {
                        ...
                        fieldsDropTarget = React.createElement("tr", null,
                            React.createElement("td", {
                                ...
                                React.createElement("div", null, "Variables")
                            ),
                            React.createElement("td", {
                                    className: "av-flds"
                                },
                    ...
                    var dataDropTarget = React.createElement("tr", null,
                        React.createElement("td", {
                            ...
                            React.createElement("div", null, "Hechos")
                        ),
                        React.createElement("td", {
                                className: "empty"
                            },
            ...
            module.exports.FilterPanel = react.createClass({
                ...
                render: function() {
                    ...
                    addCheckboxRow(filtering.ALL, '(Mostrar Todo)');
                    if (this.values.containsBlank) {
                        addCheckboxRow(filtering.BLANK, '(Blancos)');
                    }
