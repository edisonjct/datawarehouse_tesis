...
<html lang="en">
    ...
    <body class="nav-md" onload="mostrat_bitacora();">
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="alert alert-info alert-dismissible fade in">
                            ...
                            <strong>Info!</strong> En esta seccion podremos visualizar todos los ingresos de usuarios al sistema.
                        </div>
                        <div class="clearfix"></div>                        
                        <div class="row" id="">
                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        ...
                                        <ul class="nav navbar-right panel_toolbox">
                                            <button id="btn-actualizar" class="btn btn-danger" onclick="mostrat_bitacora();">Actualizar</button>
                                        </ul>
                                        <div class="clearfix"></div>                                        
                                    </div>
                                    <div class="x_content">
                                        <div id="bitacora" style="min-width: 310px; height: auto; margin: 0 auto"></div>
                                    </div>
                                </div>
                            </div>                                                                                    
                        </div>                       
