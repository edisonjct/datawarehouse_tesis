                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="alert alert-info alert-dismissible fade in">
                            ...
                            <strong>Info!</strong> Procesos ETL para generación del Cubo de Productos
                        </div>
                        <div class="clearfix"></div>                        
                        <div class="row" id="">
                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        ...
                                        <ul class="nav navbar-right panel_toolbox">
                                            <button id="btn-productos" class="btn btn-danger" onclick="etlproductos();">Procesar</button>
                                        </ul>
                                        <div class="clearfix"></div>                                        
                                    </div>
                                    <div class="x_content">
                                        <div id="etlproductos" style="min-width: 310px; height: auto; margin: 0 auto"></div>
                                    </div>
                                </div>
                            </div>                                                                                    
                        </div>                       
