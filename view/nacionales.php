                    ...
                    <div class="">                        
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>CUBO DE VENTAS NACIONALES</h2>
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form id="cubo-nacionales" class="form-horizontal form-label-left">                                          
                                            <input type="text" class="hidden" name="proceso" value="nacional" />
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                                    ...
                                                    <button type="button" id="btn-nacionales" class="btn btn-success">Procesar</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>                                    
                            ...
                            <div class="col-md-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">                                        
                                        ...
                                        <div id="cubo-ventas-nacional"></div>
                                    </div>                                    
                                </div>
                            </div>
                        </div>
